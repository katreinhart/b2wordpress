		...
		<main id="content" class="col-sm-8">
			<div class="error-404 not-found">
				<div class="page-content">
					...
					<h3>Resources</h3>
					<p>
						Perhaps you were looking for a specific resource.
					</p>
            ...
            <div class="resource">
              ...
              <p>
               ...
               <?php endif; ?>
					...
					<?php the_widget( 'WP_Widget_Archives', 'title=Our Archives', 'before_title=<h4>', 'after_title=</h4>' ) ?>

					<p>
						Or just head back to our <a href="<?php echo esc_url( home_url( '/' ) ); ?>"> home page</a>.
					</p>
